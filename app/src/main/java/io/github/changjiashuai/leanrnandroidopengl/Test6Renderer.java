...
import io.github.changjiashuai.leanrnandroidopengl.utils.ToolsUtil;
 ...
 * used instead.
 */
public class Test6Renderer implements GLSurfaceView.Renderer {
	/** Used for debug logs. */
	 ...
	 */
	public Test6Renderer(final Context activityContext) {
	...
	public void onDrawFrame(GL10 glUnused) {
		...
		int texWidth = 680, texHeight = 680;
		...
		if (status == GLES20.GL_FRAMEBUFFER_COMPLETE) {
			...
			mPositionHandle = GLES20.glGetAttribLocation(mProgramHandle,
					"a_Position");
			mColorHandle = GLES20
					.glGetAttribLocation(mProgramHandle, "a_Color");
